...
|---|---|---|
| 1 | Application Windows + UI + selection fichier + hash + historique local | En cours |
| 2 | Analyse statique PE (headers, sections, imports/exports, strings, entropie) | A venir |
